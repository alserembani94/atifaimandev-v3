...
export const getProjects = () => [
  {
    ...
    description: 'A public glossary for the crowd translation community for scientific and technology terms.',
    tenure: 'Personal',
    dateStart: '2019-01-01',
    launchStatus: 'Development',
    logoURL: '/vercel.svg',
    url: 'https://glosawam.vercel.app/',
    stacks: ['Next.js', 'Typescript', 'Tailwind CSS', 'Material UI', 'Node.js', 'AWS Amplify'].map(item => getTools(item)),
  },
  {
    name: 'InfaqYIDE',
    role: ['Frontend Developer', 'Project Manager'],
    description: 'React Native app to allow donation to charity registered under Yayasan Islam Darul Ehsan.',
  ...
  },
  {
    ...
    stacks: ['VueJS', 'Typescript', 'Tailwind CSS', 'AWS'].map(item => getTools(item)),
  },
  {
    name: 'Jombuat - Maker Community',
    role: ['Full Stack Developer', 'Co-founder'],
    description: 'A community of makers and developers from Malaysia, Indonesia, Singapore and Brunei.',
    tenure: 'Personal',
    dateStart: '2019-01-01',
    launchStatus: 'Launched',
    logoURL: '/logo/logo-jombuat.webp',
    url: 'https://www.jombuat.club/',
    stacks: ['Next.js', 'Typescript', 'Vercel', 'SASS'].map(item => getTools(item)),
  },
  {
    name: 'Jomstores - An omnichannel e-commerce platform',
    role: ['React Native Developer'],
    description: 'React Native app to allow omnichannel shopping experience, offline and online.',
    ...
    stacks: ['React', 'Node.js', 'Ant Design'].map(item => getTools(item)),
  },
  {
    name: 'Silvi - An AI-assisted Budgeting App',
    role: ['Full Stack Developer', 'Product Manager', 'DevOps Engineer'],
    description: 'React Native app to plan your budgeting and credit card management.',
    tenure: 'Personal',
    dateStart: '2019-01-01',
    launchStatus: 'Unknown',
    logoURL: '/logo/logo-aivi.webp',
    stacks: ['Next.js', 'Typescript', 'SASS', 'Node.js', 'AWS'].map(item => getTools(item)),
  },
  {
    ...
    stacks: ['React', 'Ant Design', 'Node.js', 'Express'].map(item => getTools(item)),
  },
];