...
const Stacks: React.FC = () => {
  const [
    ...
    backendStack,
    otherStack,
  ] = [getFrontendStack(), getStylingStack(), getBackendStack(), getOtherStack()];
        ...
        <div className="flex flex-row flex-wrap gap-4 my-4">
          {
            frontendStack.map((stack, index) => (
              <div key={index} className="flex flex-col items-center mb-4 w-[8ch] h-[8ch] text-center">
                <div
                  className={`
                    flex
                    items-center
                    ...
                    ease-in-out
                    text-zinc-500
                    ${stack.title === 'React' && 'hover:text-[#61dbfb] hover:rotate-90'}
                    ${stack.title === 'Typescript' && 'hover:text-[#007acc]'}
                    ${stack.title === 'Next.js' && 'hover:text-black'}
                    ${stack.title === 'VueJS' && 'hover:text-[#41B883] hover:-scale-x-125'}
              ...
              <div key={index} className="flex flex-col items-center mb-4 w-[8ch] h-[8ch] text-center">
                <div
                  className={`
                    ...
                    ease-in-out
                    text-zinc-500
                    ${stack.title === 'Tailwind CSS' && 'hover:text-[#38BDF8] hover:rotate-180'}
              ...
              <div key={index} className="flex flex-col items-center mb-4 w-[8ch] h-[8ch] text-center">
                <div
                  className={`
                    ...
                    ${stack.title === 'Apollo GraphQL' && 'hover:text-[#331D92] hover:rotate-[360deg]'}
