    ...
    activities: [
      {
        ...
        description:
          "Malaysian payment gateway solution, one of the syariah compliant fintech company. Also one of the members behind NeoCorrad and infaqYIDE.",
      },
    ],
  },
  {
    ...
    activities: [
      ...
      },
      {
        ...
        description:
          "A listing platform, featuring all developers from Malaysia, Indonesia, Singapore and Brunei. Of course, others are welcome too! Starting as a just-an-impromptu hackaton with Fajar Siddiq during JomLaunch annual event, now it is live for everyone!",
      },
    ],
  },
  {
    ...
    activities: [
      {
        ...
        description:
          "Taking introductory course for programming, I start my path to my programming journey. For a young blood, I learn C and Python. Kinda missed my lecturer, Mr. Z for his sporting charisma (we are still communicating!).",
      },
    ],
  },
  {
    ...
    activities: [
      {
        ...
        description:
          "Taking my time off waiting for foundational study transition from Kelantan to Kuala Lumpur, Malaysia, I work as replacement teacher, teaching science for primary school at my hometown.",
      },
      {
        milestone: "Buying my first own laptop 💻",
        description:
          "Using my hard earned money, I bought my first laptop for learning 😊",
      },
    ],
  },
  {
    ...
    activities: [
      {
        ...
        description:
          "A proud SMKA Sheikh Hj Mohd Said student, 5-year study experience that I won't get anywhere!",
      },
    ],
  },
  {
